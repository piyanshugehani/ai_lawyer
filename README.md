...
Suggested labels: `enhancement`, `bug`, `doc`, `infra`.

---

If you'd like, I can also:
- Generate a short `CONTRIBUTING.md` and `CODE_OF_CONDUCT.md` template.
- Add an example `.env.template` file with the environment variables listed.
- Create a short demo GIF or instructions showing the Streamlit chat flow.

Would you like me to add any of the above now?